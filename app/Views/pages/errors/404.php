            ...
            <div class="row align-items-center justify-content-center min-vh-100">
                <div class="col-md-9 col-lg-6 my-5">
                    <div class="text-center error-page">
                        <h1 class="mb-0 text-white">404</h1>
                        <h2 class="mb-4 text-white">Sorry, something went wrong!</h2>
                        <p class="w-sm-80 mx-auto mb-4 text-white">Trang này ngẫu nhiên không thể truy cập được do đang được hỗ trợ. Chúng tôi sẽ quay lại rất sớm với sự thông cảm của bạn</p>
                        <div>
                            <a href="/home/" class="btn btn-info btn-lg me-sm-2 mb-2 mb-sm-0">Trở về trang chủ</a>
                        </div>
                    </div>
                </div>
            </div>
